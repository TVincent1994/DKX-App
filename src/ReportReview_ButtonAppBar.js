...
function ReportReview_ButtonAppBar(props) {
      ...
      >
        <List>
          ...
          <ListItem button>
            ...
            <ListItemText primary="Source Control" />
          </ListItem>
          <ListItem button>
            <ListItemIcon>
              <InfoIcon />
...
ReportReview_ButtonAppBar.propTypes = {
  classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(ReportReview_ButtonAppBar);
