...
function Supervisor_AnalystReports_ButtonAppBar(props) {
    ...
    >
      <List>
        ...
        <ListItem button>
          ...
          <ListItemText primary="Analyst Reports" />
        </ListItem>
        <ListItem button>
          <ListItemIcon>
            <AssignmentIcon />
...
Supervisor_AnalystReports_ButtonAppBar.propTypes = {
  classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(Supervisor_AnalystReports_ButtonAppBar);
